    ...
    return (
        <article className='relative h-56 rounded-xl overflow-hidden'>
            ...
            <div className='absolute bottom-2 left-2'>
                ...
                <p className='flex items-center gap-1'><MapPin size="18" />{location}</p>
                <p className='flex items-center gap-1'><Calendar size="18" />{date}</p>
                <p className='flex items-center gap-1'><Users size="18" />{people} personas</p>
            </div>
            <button
